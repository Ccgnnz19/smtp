...
More tools share here : https://t.me/prv8toolsleaks


''' 
ms0g = 'Goodluck for get more SMTP bro'		
for i in ms0g:		
    sys.stdout.write(i)		
    sys.stdout.flush()		
    time.sleep(0.09)
...
class consumer(threading.Thread):
	...
	def connect(self,tupple,ssl=False):
		...
		#	print rez
			...
			headers+='Hello from Facebook Reset link\r\n.\r\n'
				#print headers
			s.send(headers)
			rez=s.recv(1000)
